...
class ComputeLossComponent:
    # Compute losses
    def __init__(self, model, autobalance, nc):
        super(ComputeLossComponent, self).__init__()
        device = next(model.parameters()).device  # get model device
        h = model.hyp  # hyperparameters
...
class ComputeLossMultiple:

    def __init__(self, model):
        self.n_dataset = model.n_dataset
        self.nc = model.nc
        self.multiple_nc = model.multiple_nc
